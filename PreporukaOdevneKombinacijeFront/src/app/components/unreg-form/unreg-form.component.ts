...
export class UnregFormComponent implements OnInit {
  ...
  onSubmit(form) {   
    console.log(form);
    var unos = new UnosNeul(this.myForm.get('ramena').value, this.myForm.get('kukovi').value, this.myForm.get('struk').value, this.myForm.get('visina').value, this.myForm.get('dresscode').value, this.myForm.get('bojaKoze').value, this.myForm.get('vreme').value,this.myForm.get('pol').value  ); 
