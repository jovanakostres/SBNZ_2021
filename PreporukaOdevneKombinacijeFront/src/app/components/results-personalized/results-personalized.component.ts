...
@Component({
  selector: 'app-results-personalized',
  templateUrl: './results-personalized.component.html',
  styleUrls: ['./results-personalized.component.scss']
})
export class ResultsPersonalizedComponent implements OnInit {

  @Input() data: PreporuceniKomadi;
